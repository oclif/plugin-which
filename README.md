...
@oclif/plugin-which/3.2.8 linux-x64 node-v18.20.3
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.2.8/src/commands/which.ts)_
