...
@oclif/plugin-which/3.3.0 linux-x64 node-v22.23.2
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.3.0/src/commands/which.ts)_
<!-- commandsstop -->
