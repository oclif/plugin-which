...
@oclif/plugin-which/3.2.32 linux-x64 node-v20.18.3
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.2.32/src/commands/which.ts)_
