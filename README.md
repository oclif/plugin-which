...
@oclif/plugin-which/4.0.1 linux-x64 node-v22.23.2
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/4.0.1/src/commands/which.ts)_
<!-- commandsstop -->
