...
@oclif/plugin-which/3.1.3 linux-x64 node-v18.19.1
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.1.3/src/commands/which.ts)_
