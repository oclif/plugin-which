...
@oclif/plugin-which/3.2.57 linux-x64 node-v22.22.3
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.2.57/src/commands/which.ts)_
