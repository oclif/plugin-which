...
@oclif/plugin-which/3.2.13 linux-x64 node-v18.20.4
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.2.13/src/commands/which.ts)_
