...
@oclif/plugin-which/3.2.59 linux-x64 node-v22.23.1
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.2.59/src/commands/which.ts)_
<!-- commandsstop -->
