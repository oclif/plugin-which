...
@oclif/plugin-which/3.2.58 linux-x64 node-v22.23.0
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.2.58/src/commands/which.ts)_
