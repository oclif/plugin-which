...
@oclif/plugin-which/3.2.22 linux-x64 node-v20.18.1
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.2.22/src/commands/which.ts)_
