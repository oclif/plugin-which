...
@oclif/plugin-which/3.1.8 linux-x64 node-v18.20.2
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.1.8/src/commands/which.ts)_
