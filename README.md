...
@oclif/plugin-which/3.2.37 linux-x64 node-v20.19.2
...
_See code: [src/commands/which.ts](https://github.com/oclif/plugin-which/blob/3.2.37/src/commands/which.ts)_
