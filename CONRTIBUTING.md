...
```bash
$ git clone git@github.com:oclif/plugin-which.git
```

**2. Navigate into project & install development-specific dependencies...**

```bash
$ cd ./plugin-which && yarn
```
...
**6. Open a [Pull Request](https://github.com/oclif/plugin-which/pulls) for your work & become the newest contributor to `@oclif/plugin-which`! 🎉**
